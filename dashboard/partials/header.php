        ...
        <div class="page-sidebar">
            ...
            <div class="page-sidebar-inner slimscroll">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="bio_santri.php"><i class="material-icons-outlined">account_circle</i>Biodata Calon Santri</a>
                    </li>
                    <li>
                        <a href="bio_ayah.php"><i class="material-icons-outlined">account_circle</i>Biodata Ayah</a>
                    </li>
                    <li>
                        <a href="bio_ibu.php"><i class="material-icons-outlined">account_circle</i>Biodata Ibu</a>
                    </li>
                    <li class="sidebar-title">
                        Lainnya
                    </li>
                    <li>
                        <a href="jadwal_ujian.php"><i class="material-icons">videocam</i>Pilih Jadwal Ujian</a>
                    </li>
                </ul>
            </div>
        </div>